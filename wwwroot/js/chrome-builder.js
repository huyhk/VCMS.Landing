...
const choices={background:['surface','brand','contrast','transparent','image'],height:['compact','standard','large'],container:['boxed','full'],width:['auto','fill','1','2','3','4'],align:['left','center','right']};
